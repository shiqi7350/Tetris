...
public class Lua_UnityEngine_Experimental_Rendering_CullResults : LuaObject {
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_visibleOffscreenVertexLights(IntPtr l) {
		try {
			UnityEngine.Experimental.Rendering.CullResults self;
			checkValueType(l,1,out self);
			UnityEngine.Experimental.Rendering.VisibleLight[] v;
			checkArray(l,2,out v);
			self.visibleOffscreenVertexLights=v;
			setBack(l,self);
			pushValue(l,true);
			return 1;
		}
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,"visibleOffscreenVertexLights",get_visibleOffscreenVertexLights,set_visibleOffscreenVertexLights,true);
