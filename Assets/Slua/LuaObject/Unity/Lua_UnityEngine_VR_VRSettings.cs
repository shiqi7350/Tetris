...
public class Lua_UnityEngine_VR_VRSettings : LuaObject {
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_occlusionMaskScale(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,UnityEngine.VR.VRSettings.occlusionMaskScale);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_occlusionMaskScale(IntPtr l) {
		try {
			float v;
			checkType(l,2,out v);
			UnityEngine.VR.VRSettings.occlusionMaskScale=v;
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,"occlusionMaskScale",get_occlusionMaskScale,set_occlusionMaskScale,false);
